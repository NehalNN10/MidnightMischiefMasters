...
Level::Level(int p1X, int p1Y, int p2X, int p2Y, int cX, int cY, int *ppX, int *ppY, map *lvl) : player1X(p1X), player1Y(p1Y), player2X(p2X), player2Y(p2Y), chaserX(cX), chaserY(cY), paperPositionsX(ppX), paperPositionsY(ppY), levelMap(lvl)
{
    completed = false;
